...
export default function AdminLayout({title, email, children}: AdminLayoutProps) {
	...
	return (
		<>
			...
			<div className={`${raleway.className} min-h-screen bg-light dark:bg-dark`}>
				<header className='border-b border-border bg-stone-200 dark:bg-zinc-800'>
					<div className='max-w-6xl mx-auto px-4 py-4 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between'>
						<div>
							...
							<h1 className='text-xl font-bold text-primary'>Camilo Meza AF</h1>
						</div>
